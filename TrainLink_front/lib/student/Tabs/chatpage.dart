...
class ChatPage extends StatefulWidget {
  ...
  ChatPage(
      {required this.name, required this.profileurl, required this.username, required this.sinfo,required this.chatid});
...
//done
  getthesharedpref() async {
    myUserName = widget.sinfo['RegNum'];
    myProfilePic = widget.sinfo['img'];
    myName = widget.sinfo['fname']+" "+widget.sinfo['lname'];
    myEmail = widget.sinfo['SEmail'];
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.pushReplacement(context,
                          MaterialPageRoute(builder: (context) => Home(widget.sinfo)));
                    },
                    child: Icon(
